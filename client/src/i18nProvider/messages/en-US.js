...
export default {
  [LOCALES.ENGLISH]: {
    ...
    "question-validation-max-length": "Characters limit is 200",
    "question-validation-required": "Question is required",
    "category-validation-available-options": "Category must be one of the available options",
    "category-validation-required": "Category is required",
    "time-limit-validation-required": "Time limit is required",
    "time-limit-validation-min": "Time limit must be at least 10 seconds",
    "time-limit-validation-max": "Time limit must be no more than 60 seconds",
    "answer1-validation-max-length": "Characters limit is 100",
